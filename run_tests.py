...
class TestSocket(unittest.TestCase):
    ...
    def test_register(self): 
        ...
        expected_results = ["Registered successfully, please login..", "User already exists" ]
        results = []
        test_vectors = [ "register testadmin testpwd admin", "register testadmin testpwd admin"]                    
